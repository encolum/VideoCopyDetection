...
class OverlayText(ImageOnlyTransform):
    def __init__(self, always_apply=False, p=0.1):
        super().__init__(always_apply=always_apply, p=p)
    def apply(self, img, **params):
        return overlay_text(img)
...
class RandomOverlayCorners(BaseTransform):
    ...
    def __init__(self, always_apply=False, p=0.5):
        ...
        self._c1 = Image.open(r"D:\VideoMatching_latest\data\meta\bg_img\1_bg.png")
        self._c2 = Image.open(r"D:\VideoMatching_latest\data\meta\bg_img\2_bg.png")
        self._c3 = Image.open(r"D:\VideoMatching_latest\data\meta\bg_img\3_bg.png")
        self._c4 = Image.open(r"D:\VideoMatching_latest\data\meta\bg_img\4_bg.png")
