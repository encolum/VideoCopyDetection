...
def parse_args():
    ...
    parser.add_argument('--config', type=str, default=r"D:\VideoMatching_latest\train\train_vid_score\config_for_video_score_train_hf.py")  # Đường dẫn file cấu hình
    ...
    parser.add_argument('--feat_dim', type=int, default=512)  # Kích thước feature
    ...
    parser.add_argument('--bert_path', type=str, default=r"D:\VideoMatching\checkpoints_train_vid_score\googlebert-base")  # Đường dẫn pretrained BERT
    ...
    parser.add_argument('--resume', type=str, default=r"D:\VideoMatching_latest\train\train_vid_score\checkpoints_hf")  # Đường dẫn checkpoint để tiếp tục train
...
def main(args, cfg):
    ...
    os.makedirs(f'{work_dir}/checkpoints_hf', exist_ok=True)
    ...
    fh = logging.FileHandler(work_dir + '/log_hf.txt')
    ...
    for epoch in tqdm.tqdm(range(start_epoch, epochs), desc = 'Epochs'):
        ...
        torch.save(checkpoint, f'{args.work_dir}/checkpoints_hf/epoch_{epoch + 1 }.pt')
